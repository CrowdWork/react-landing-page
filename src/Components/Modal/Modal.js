    ...
    <>
      ...
      <div id="my-id" uk-modal="true">
        <div className="uk-modal-dialog uk-modal-body">
          <h2 className="uk-modal-title uk-heading-small">{props.campaign}</h2>
          <hr className="uk-divider-icon" />
          <p>
            Specialized note here about the fundraiser: Lorem ipsum dolor sit
            amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt
            ut labore et dolore magna aliqua. Ullamcorper morbi tincidunt ornare
            ...
            <div className="supportecosystem">
              ...
              <div id="threepercent">
                <input
                  ...
                  name="recurring"
                />
                <label id="threepercent_lbl"></label>
              </div>
              <div id="sixpercent">
                <input
                  className="uk-checkbox"
